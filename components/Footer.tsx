        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/track" className="text-gray-400 hover:text-accent transition-colors text-sm">
                  Track Shipment
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <div>
                  <a href="tel:+254722227172" className="text-gray-400 hover:text-accent transition-colors text-sm block">
                    0722 227 172
                  </a>
                  <a href="tel:+254714848821" className="text-gray-400 hover:text-accent transition-colors text-sm block">
                    0714 848 821
                  </a>
                </div>
              </li>
              ...
              <li className="flex items-start space-x-3">
                ...
                <a href="mailto:info@rollermax.co.ke" className="text-gray-400 hover:text-accent transition-colors text-sm">
